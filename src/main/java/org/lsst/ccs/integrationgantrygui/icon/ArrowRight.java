 ...
 * transcoder</a>.
 */
public class ArrowRight implements javax.swing.Icon {
    ...
    private static void paint(Graphics2D g) {
        ...
        // _0
        // _0_0
        Shape shape = new Line2D.Float(5.000000f, 12.000000f, 19.000000f, 12.000000f);
        g.setPaint(BLACK);
        ...
        ((GeneralPath) shape).moveTo(12.0, 5.0);
