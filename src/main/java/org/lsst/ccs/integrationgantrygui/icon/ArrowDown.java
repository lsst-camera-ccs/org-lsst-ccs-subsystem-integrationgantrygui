 ...
 * transcoder</a>.
 */
public class ArrowDown implements javax.swing.Icon {
     ...
     * Creates a new transcoded SVG image.
     */
    public ArrowDown(int width, int height) {
        this.width = width;
        this.height = height;
    }
    ...
    private static void paint(Graphics2D g) {
        ...
        // _0
        // _0_0
        Shape shape = new Line2D.Float(12.000000f, 5.000000f, 12.000000f, 19.000000f);
        g.setPaint(BLACK);
        ...
        ((GeneralPath) shape).moveTo(19.0, 12.0);
        ((GeneralPath) shape).lineTo(12.0, 19.0);
